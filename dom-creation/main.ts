...
function renderPokemon(pokemon: Pokemon): HTMLDivElement {
  ...
  $nestedDiv2.appendChild($h2);
  $nestedDiv2.appendChild($h3);
  $nestedDiv2.appendChild($p);

  $nestedDiv1.appendChild($img);
